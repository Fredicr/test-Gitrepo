...
import logo1 from '../assets/KSHCOIN_LOGO_1_BLACK.png';
import logo2 from '../assets/KSHCOIN_LOGO_1_WHITE_50.png'
...
function App() {
  ...
  return(
    <div className="App">
      <img className="logo" src={logo2} alt="KSH-Heerbrugg Logo" /> 
      <h3>KSH-COIN</h3>
      <br />
